...
export const shops = [
  {
    ...
    products: [
      ...
      product('koa-robe-lina', 'Robe Lina beige', productImages.koa_robe_lina, 'Vetements', '42 500 FCFA', '4 pieces', 'Robe fluide beige, coupe elegante et tissu doux.', { premium: true, certified: true }),
      product('koa-sneaker-rouge', 'Sneaker Rouge', productImages.koa_sneaker_rouge, 'Chaussures', '38 000 FCFA', '9 paires', 'Sneaker rouge sportive, semelle confortable et look urbain.', { premium: true }),
      product('koa-lunettes-sol', 'Lunettes Sol', productImages.koa_lunettes_sol, 'Accessoires', '16 500 FCFA', '12 pieces', 'Lunettes solaires noires, monture fine et protection UV.', { certified: true }),
      product('koa-montre-line', 'Montre Line acier', productImages.koa_montre_line, 'Bijoux', '29 000 FCFA', '6 pieces', 'Montre acier minimaliste avec cadran clair.', { premium: true }),
  ...
  },
  {
    ...
    products: [
      ...
      product('talia-robe-sand', 'Robe Sand', productImages.talia_robe_sand, 'Vetements', '36 000 FCFA', 'En stock', 'Robe sable elegante, ideale sortie et bureau.'),
      product('talia-basic-tee', 'T-shirt Basic', productImages.talia_basic_tee, 'Vetements', '12 500 FCFA', '18 pieces', 'T-shirt coton blanc, coupe simple et propre.', { certified: true }),
      product('talia-red-runner', 'Red Runner', productImages.talia_red_runner, 'Chaussures', '44 000 FCFA', '10 paires', 'Basket rouge confortable pour style casual.'),
      product('talia-bracelet-or', 'Bracelet Or fin', productImages.talia_bracelet_or, 'Bijoux', '18 000 FCFA', '8 pieces', 'Bracelet fin couleur or, fermoir discret.', { certified: true }),
  ...
  },
  {
    ...
    products: [
      ...
      product('noma-laptop-desk', 'Laptop Desk 14', productImages.noma_laptop_desk, 'Ordinateurs', '325 000 FCFA', 'En stock', 'Laptop 14 pouces, SSD rapide et clavier confortable.', { premium: true }),
      product('noma-casque-pro', 'Casque Noma Pro', productImages.noma_casque_pro, 'Audio', '37 000 FCFA', '8 pieces', 'Casque bluetooth noir, son clair et coussinets doux.', { premium: true }),
      product('noma-watch-pro', 'Watch Pro', productImages.noma_watch_pro, 'Montres connectees', '49 000 FCFA', '5 pieces', 'Montre connectee sport avec suivi quotidien.', { premium: true }),
      product('noma-speaker-mini', 'Speaker Mini', productImages.noma_speaker_mini, 'Audio', '21 500 FCFA', '9 pieces', 'Enceinte bluetooth compacte, basse nette et autonomie fiable.'),
  ...
  },
  {
    ...
    products: [
      ...
      product('sony-tv-bravia-55', 'Sony TV Bravia 55', productImages.sony_tv_bravia_55, 'Televisions', '650 000 FCFA', '3 pieces', 'Televiseur 55 pouces 4K, image nette et son immersif.', { premium: true, certified: true }),
      product('sony-wh-headset', 'Casque Sony WH', productImages.sony_wh_headset, 'Audio', '155 000 FCFA', '8 pieces', 'Casque reduction de bruit, son propre et autonomie longue.', { premium: true }),
      ...
      product('sony-watch-pro', 'Sony Watch Pro', productImages.sony_watch_pro, 'Montres connectees', '110 000 FCFA', '6 pieces', 'Montre connectee Sony, bracelet clair et suivi quotidien.', { premium: true }),
  ...
  },
  {
    ...
    products: [
      ...
      product('sawa-mini-bag', 'Mini Bag orange', productImages.sawa_mini_bag, 'Accessoires', '20 000 FCFA', '10 pieces', 'Sac tendance couleur chaude avec fermeture solide.'),
      product('sawa-airbuds-lite', 'Airbuds Lite', productImages.sawa_airbuds_lite, 'Audio', '18 500 FCFA', 'En stock', 'Ecouteurs sans fil simples et boitier compact.'),
      product('sawa-phone-plus', 'Phone Plus 64', productImages.sawa_phone_plus, 'Telephones', '95 000 FCFA', '12 pieces', 'Telephone 64 Go, double SIM et batterie correcte.'),
      product('sawa-speaker-go', 'Speaker Go', productImages.sawa_speaker_go, 'Audio', '21 000 FCFA', '15 pieces', 'Mini enceinte bluetooth pour maison et boutique.'),
  ...
  },
  {
    ...
    products: [
      ...
      product('mboa-bague-saphir', 'Bague Saphir', productImages.mboa_bague_saphir, 'Bijoux', '72 000 FCFA', '4 pieces', 'Bague elegante avec pierre bleue et finition brillante.', { certified: true }),
      product('mboa-bracelet-cuir', 'Bracelet Cuir', productImages.mboa_bracelet_cuir, 'Bijoux', '18 000 FCFA', 'En stock', 'Bracelet cuir marron avec boucle metal.'),
      product('mboa-boucles-pearl', 'Boucles Pearl', productImages.mboa_boucles_pearl, 'Bijoux', '28 000 FCFA', '8 paires', 'Boucles perle discretes pour tenue chic.'),
      product('mboa-montre-classic', 'Montre Classic', productImages.mboa_montre_classic, 'Bijoux', '55 000 FCFA', '5 pieces', 'Montre classique, cadran noir et bracelet acier.', { certified: true }),
  ...
  },
  {
    ...
    products: [
      ...
      product('oud-vanille', 'Vanille Ambree', productImages.oud_vanille, 'Parfums', '39 000 FCFA', 'En stock', 'Parfum vanille ambree, doux et chaleureux.'),
      product('oud-musc-blanc', 'Musc Blanc', productImages.oud_musc_blanc, 'Parfums', '32 000 FCFA', '10 pieces', 'Musc propre, discret et ideal au quotidien.'),
      product('oud-coffret-luxe', 'Coffret Luxe', productImages.oud_coffret_luxe, 'Parfums', '115 000 FCFA', '3 sets', 'Coffret premium avec trois senteurs et boite cadeau.', { premium: true, certified: true }),
      product('oud-huile-corps', 'Huile Corps', productImages.oud_huile_corps, 'Soins', '18 500 FCFA', '12 pieces', 'Huile parfumee pour peau douce et brillante.'),
  ...
  },
  {
    ...
    products: [
      ...
      product('sika-poele-granit', 'Poele Granit', productImages.sika_poele_granit, 'Ustensiles', '18 500 FCFA', 'En stock', 'Poele antiadhesive effet granit, manche robuste.'),
      product('sika-set-couteaux', 'Set Couteaux', productImages.sika_set_couteaux, 'Ustensiles', '22 000 FCFA', '8 sets', 'Set de couteaux cuisine avec support compact.'),
      product('sika-mixeur-plus', 'Mixeur Plus', productImages.sika_mixeur_plus, 'Electromenager', '45 000 FCFA', '6 pieces', 'Mixeur electrique pour jus, sauces et cuisine maison.'),
      product('sika-assiettes-ceram', 'Assiettes Ceram', productImages.sika_assiettes_ceram, 'Vaisselle', '19 000 FCFA', '10 sets', 'Set assiettes ceramique beige, finition propre.'),
  ...
  },
  {
    ...
    products: [
      ...
      product('vision-tv-65', 'TV Vision 65 OLED', productImages.vision_tv_65, 'Televisions', '890 000 FCFA', '2 pieces', 'Grand televiseur 65 pouces OLED pour salon premium.', { premium: true, certified: true }),
      product('vision-projecteur-mini', 'Projecteur Mini', productImages.vision_projecteur_mini, 'Image', '180 000 FCFA', '4 pieces', 'Projecteur compact pour films, cours et presentations.', { premium: true }),
      product('vision-soundbar-home', 'Soundbar Home', productImages.vision_soundbar_home, 'Audio', '165 000 FCFA', '5 pieces', 'Barre de son salon avec basse profonde.', { premium: true }),
      product('vision-support-tv', 'Support TV mural', productImages.vision_support_tv, 'Accessoires', '18 000 FCFA', 'En stock', 'Support mural solide pour television 32 a 65 pouces.'),
  ...
  },
  {
    ...
    products: [
      ...
      product('kids-basket-school', 'Basket School', productImages.kids_basket_school, 'Chaussures', '18 000 FCFA', '10 paires', 'Basket enfant resistante pour ecole et sortie.'),
      product('kids-sac-ecole', 'Sac Ecole Bleu', productImages.kids_sac_ecole, 'Accessoires', '14 000 FCFA', 'En stock', 'Sac ecole bleu avec compartiments solides.'),
      product('kids-gourde-inox', 'Gourde Inox', productImages.kids_gourde_inox, 'Ustensiles', '7 500 FCFA', '20 pieces', 'Gourde inox enfant, bouchon securise.'),
      product('kids-pyjama-coton', 'Pyjama Coton', productImages.kids_pyjama_coton, 'Vetements', '12 000 FCFA', '15 pieces', 'Pyjama coton doux pour nuit confortable.'),
